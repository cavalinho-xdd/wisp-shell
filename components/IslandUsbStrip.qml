...
Item {
    ...
    readonly property bool active: Island.current === "usb"
    readonly property bool isConnect: Island.usbFlashIsConnect
    
    // Force Usb singleton to instantiate so the watcher script runs
    property string _forceInit: Usb.lastEvent
